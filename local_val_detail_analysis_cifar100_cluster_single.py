...
import cluster_val_single_detail_analysis_cifar100
...
for i in range(len(holdout_class_list)):
    ...
    for ratio in range(11):
        ...
        cluster_val_single_detail_analysis_cifar100.evaluate_model(NO_RUNS, data_folder, result_folder, mode, holdout_class, holdout_target, ratio)
